...
public class ServicioArchivo implements IServicioArchivo {
    ...
    private void sizeVerify(MultipartFile multipart) {
        if(multipart.getSize() > MAX_SIZE_UPLOAD) throw new MaxUploadSizeExceededException(MAX_SIZE_UPLOAD, new Throwable("La imagen no puede superar " + MAX_SIZE_UPLOAD/1000000 + " Mb"));
    }
