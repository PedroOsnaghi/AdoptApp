            ...
            addedfile: function (e) {
                if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews)) {
                    ...
                    this.options.addRemoveLinks &&
                        ((e._removeLink = f.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>"))), e.previewElement.appendChild(e._removeLink));
                    var p = function (i) {
                            var n = t;
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t, i) {
                                ...
                                var m = this.options.defaultHeaders ? { Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest" } : {};
                                    ...
                                    try {
                                        for (var s, u = e[Symbol.iterator](); !(n = (s = u.next()).done); n = !0) {
                                            ...
                                            ((c = s.value).upload.total && c.upload.bytesSent && c.upload.bytesSent == c.upload.total) ||
                                                (i ? ((c.upload.progress = (100 * i.loaded) / i.total), (c.upload.total = i.total), (c.upload.bytesSent = i.loaded)) : ((c.upload.progress = 100), (c.upload.bytesSent = c.upload.total)),
