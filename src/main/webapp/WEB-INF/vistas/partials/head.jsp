...
<!doctype html>
<html lang="es" class="theme-fs-md">
...
<head>
   ...
   <!-- End Config Options -->
   <link rel="icon" href="${pageContext.request.contextPath}/images/brand/favicon.png" type="image/png" sizes="32x32" />
   <link rel="stylesheet" href="${pageContext.request.contextPath}/css/libs.min.css">
   <link rel="stylesheet" href="${pageContext.request.contextPath}/css/socialv006a.css?v=5.0.2">
   <link rel="stylesheet"
      href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
   <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,700&amp;display=swap" rel="stylesheet">
   <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500&amp;display=swap" rel="stylesheet">
   <!-- flatpickr css -->
   <link rel="stylesheet" href="${pageContext.request.contextPath}/vendor/flatpickr/dist/flatpickr.min.css" />
   <!-- Sweetlaert2 css -->
   <link rel="stylesheet" href="${pageContext.request.contextPath}/vendor/sweetalert2/dist/sweetalert2.min.css" />

   <!-- vanillajs css -->
   <link rel="stylesheet" href="${pageContext.request.contextPath}/vendor/vanillajs-datepicker/dist/css/datepicker.min.css">
