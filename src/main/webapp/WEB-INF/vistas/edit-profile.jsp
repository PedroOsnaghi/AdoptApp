                                          ...
                                          <form action="" method="post">
                                             ...
                                             <form action="" method="post">
                                                <div class="row">
                                                   ...
                                                   -->
                                                         ...
                                                         <img class="avatar-130 img-fluid" src="images/user/1.jpg"
                                                            id="preview" alt="">
                                                         <div class="material-symbols-outlined btn btn-primary btn-profile">
                                                            photo_camera
                                                            <input path="imagen" name="archivoImagen" id="file"
                                                               type="file" class="form-control opacity-0" />
                                                   ...
                                                   <div class="form-group col-8">
                                                      <label class="form-label" for="fname">Tu presentacíon</label>
                                             ...
                                             <div class="row">
                                                <div class="form-group col-6">
                                                   <label class="form-label" for="fname">Nombre y Apellido *</label>
                                                   <input type="text" class="form-control" id="fname" name="fname"
                                                      placeholder="Escribí tu nombre completo" value="Juan Daniel"
                                                ...
                                                <div class="form-group col-6">
                                                   <label class="form-label" for="fname">Cuál es tu dirección?</label>
                                                   <input type="text" class="form-control" id="fname" name="fname"
                                                      placeholder="Buscá tu domicilio aquí.." required="required"
                                                ...
                                                <div class="col-6">
                                                   ...
                                                   <input type="text" class="form-control" id="fname" name="fname"
                                                      placeholder="Suipacha 110" readonly required="required"
                                                      control-id="ControlID-3">
                                                   <label class="form-label" for="fname">Ciudad</label>
                                                   <input type="text" class="form-control" id="fname" name="fname"
                                                      placeholder="Ramos Mejia" readonly required="required"
                                                      control-id="ControlID-3">
                                                   <label class="form-label" for="fname">Provincia</label>
                                                   <input type="text" class="form-control" id="fname" name="fname"
                                                      placeholder="Buenos Aires" readonly required="required"
                                                      control-id="ControlID-3">
